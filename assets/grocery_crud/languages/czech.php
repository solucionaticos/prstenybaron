<?php
	...
	$lang['list_export'] 	= "Vývozní"; //"Export";
	$lang['list_print'] 	= "Vytisknout"; //"Print";
	$lang['minimize_maximize'] = 'Minimalizovat / Maximalizovat'; //'Minimize/Maximize';

	/* Added in version 1.4 */
	$lang['list_view'] = 'Pohled'; //'View';
	...
	$lang['list_more'] = 'Více'; //'More';

	/* Added in version 1.5.6 */
	$lang['list_search_column'] = 'Vyhledávání {column_name}'; //'Search {column_name}';

	/* Added in version 1.5.8 */
	$lang['alert_delete_multiple'] = 'Opravdu chcete tyto položky {items_amount} smazat?'; //'Are you sure that you want to delete those {items_amount} items?';

	$lang['alert_delete_multiple_one'] = 'Opravdu chcete tuto položku smazat?'; //'Are you sure that you want to delete this 1 item?';



	/* Added in version 1.6.1 */
	$lang['list_clone'] = 'Klon'; //'Clone';
